...
static __Pyx_memviewslice __pyx_f_14selection_sort_selection_sort(PyObject *, int, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_14selection_sort_selection_sort(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_a_list, int __pyx_v_l); /* proto */
...
static __Pyx_memviewslice __pyx_f_14selection_sort_selection_sort(PyObject *__pyx_v_a_list, int __pyx_v_l, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_v_a_list);
  PyTuple_SET_ITEM(__pyx_t_1, 1, __pyx_v_a_list);
 ...
 *         smallest = i
 */
  __pyx_t_3 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(((PyObject *)__pyx_v_a), PyBUF_WRITABLE); if (unlikely(!__pyx_t_3.memview)) __PYX_ERR(0, 7, __pyx_L1_error)
  __pyx_v_x_list = __pyx_t_3;
  __pyx_t_3.memview = NULL;
  __pyx_t_3.data = NULL;

  /* "selection_sort.pyx":8
 *     cdef array.array a = array.array('l', a_list)
 *     cdef int[:] x_list = a
 *     for i in range(0, l - 1):             # <<<<<<<<<<<<<<
 *         smallest = i
 ...
 */
      ...
      __pyx_t_11 = -1;
      if (__pyx_t_10 < 0) {
        __pyx_t_10 += __pyx_v_x_list.shape[0];
        if (unlikely(__pyx_t_10 < 0)) __pyx_t_11 = 0;
      } else if (unlikely(__pyx_t_10 >= __pyx_v_x_list.shape[0])) __pyx_t_11 = 0;
      if (unlikely(__pyx_t_11 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_11);
        __PYX_ERR(0, 11, __pyx_L1_error)
      }
      __pyx_t_12 = __pyx_v_smallest;
      __pyx_t_11 = -1;
      if (__pyx_t_12 < 0) {
        __pyx_t_12 += __pyx_v_x_list.shape[0];
        if (unlikely(__pyx_t_12 < 0)) __pyx_t_11 = 0;
      } else if (unlikely(__pyx_t_12 >= __pyx_v_x_list.shape[0])) __pyx_t_11 = 0;
      if (unlikely(__pyx_t_11 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_11);
        __PYX_ERR(0, 11, __pyx_L1_error)
      }
      __pyx_t_13 = (((*((int *) ( /* dim=0 */ (__pyx_v_x_list.data + __pyx_t_10 * __pyx_v_x_list.strides[0]) ))) < (*((int *) ( /* dim=0 */ (__pyx_v_x_list.data + __pyx_t_12 * __pyx_v_x_list.strides[0]) )))) != 0);
      if (__pyx_t_13) {

        /* "selection_sort.pyx":12
 *         for j in range(i + 1, l):
 *             if x_list[j] < x_list[smallest]:
 *                 smallest = j             # <<<<<<<<<<<<<<
 *         x_list[i], x_list[smallest] = x_list[smallest], x_list[i]
 ...
 */
    ...
    } else if (unlikely(__pyx_t_12 >= __pyx_v_x_list.shape[0])) __pyx_t_7 = 0;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 13, __pyx_L1_error)
    }
    __pyx_t_7 = (*((int *) ( /* dim=0 */ (__pyx_v_x_list.data + __pyx_t_12 * __pyx_v_x_list.strides[0]) )));
    __pyx_t_12 = __pyx_v_i;
    __pyx_t_8 = -1;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_v_x_list.shape[0];
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_8 = 0;
    } else if (unlikely(__pyx_t_12 >= __pyx_v_x_list.shape[0])) __pyx_t_8 = 0;
    if (unlikely(__pyx_t_8 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_8);
      __PYX_ERR(0, 13, __pyx_L1_error)
    }
    __pyx_t_8 = (*((int *) ( /* dim=0 */ (__pyx_v_x_list.data + __pyx_t_12 * __pyx_v_x_list.strides[0]) )));
    __pyx_t_12 = __pyx_v_i;
    __pyx_t_9 = -1;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_v_x_list.shape[0];
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_9 = 0;
    } else if (unlikely(__pyx_t_12 >= __pyx_v_x_list.shape[0])) __pyx_t_9 = 0;
    if (unlikely(__pyx_t_9 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_9);
      __PYX_ERR(0, 13, __pyx_L1_error)
    }
    *((int *) ( /* dim=0 */ (__pyx_v_x_list.data + __pyx_t_12 * __pyx_v_x_list.strides[0]) )) = __pyx_t_7;
    __pyx_t_12 = __pyx_v_smallest;
    __pyx_t_7 = -1;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_v_x_list.shape[0];
    ...
    *((int *) ( /* dim=0 */ (__pyx_v_x_list.data + __pyx_t_12 * __pyx_v_x_list.strides[0]) )) = __pyx_t_8;
  }

  /* "selection_sort.pyx":14
 *                 smallest = j
 *         x_list[i], x_list[smallest] = x_list[smallest], x_list[i]
 *     return x_list             # <<<<<<<<<<<<<<
 */
  __PYX_INC_MEMVIEW(&__pyx_v_x_list, 0);
  __pyx_r = __pyx_v_x_list;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_14selection_sort_1selection_sort(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_a_list,&__pyx_n_s_l,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_a_list)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_l)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("selection_sort", 1, 2, 2, 1); __PYX_ERR(0, 4, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "selection_sort") < 0)) __PYX_ERR(0, 4, __pyx_L3_error)
      }
    ...
    __pyx_v_a_list = ((PyObject*)values[0]);
    __pyx_v_l = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_l == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 4, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("selection_sort", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 4, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("selection_sort.selection_sort", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_a_list), (&PyList_Type), 1, "a_list", 1))) __PYX_ERR(0, 4, __pyx_L1_error)
  __pyx_r = __pyx_pf_14selection_sort_selection_sort(__pyx_self, __pyx_v_a_list, __pyx_v_l);
...
static PyObject *__pyx_pf_14selection_sort_selection_sort(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_a_list, int __pyx_v_l) {
  ...
  __pyx_t_1 = __pyx_f_14selection_sort_selection_sort(__pyx_v_a_list, __pyx_v_l, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 4, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "selection_sort.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "selection_sort._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"selection_sort", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_14selection_sort_1selection_sort, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("selection_sort", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
